...
setup(
    ...
    description="A tool to format OpenFOAM files",
    long_description="%s\n%s"
    % (
    ...
    author_email="gregor.olenik@kit.edu",
    url="https://github.com/exasim-project/foam-format",
    ...
    entry_points={
        "console_scripts": [
            "foam-format = foam_format.cli:main",
        ]
    },
)
